"""Альтернативная реализация задания 2 для разбора теми студентами,
которые хотят и могут изучить больше"""
...
def create_link():
    ...
    return render_template('task2_for_advaced_learners.html',
                           name=name, url=url,
                           error=error_message,
